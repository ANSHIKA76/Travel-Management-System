...
public class checkPackages extends JFrame{
    ...
    public JPanel createPackage(String[] pack){
        ...
        lblName.setFont(new Font("Times New Roman", Font.PLAIN, 40));
